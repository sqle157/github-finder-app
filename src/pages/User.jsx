...
function User() {
	...
	// Everytime we update our state, getUser & getUserRepos get recreated, which lead to useEffect fire off because the functions are the dependencies of useEffect
	// useEffect(() => {
